...
| `search_emails` | 2026-09-14, 2026-09-15 | Term "Cargill": 26 matches with an exact total; `scope=subject` returned 5, `scope=sender` returned 1; a term trying to break out of the phrase returned empty with no 400. |
