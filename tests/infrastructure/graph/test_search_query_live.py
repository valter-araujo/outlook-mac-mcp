...
Measured 2026-09-14 against a personal Outlook.com mailbox:
    ...
    "\"http\""                                    matched a full page
    "http AND from:<a real sender address>"        filtered to one match, operators executed
    "\"http AND from:<a real sender address>\""    matched nothing, literal, as intended
